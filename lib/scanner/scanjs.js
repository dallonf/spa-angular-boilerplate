...
module.exports = function(dirsConfig, basedir) {
  ...
  dirsConfig.forEach(function(dirConfig) {
    ...
    jsFilesNested.push(scanFolder(dirConfig, basedir, path.join(basedir, dirConfig.dir)));
...
function scanFolder(dirConfig, basedir, dirPath) {
  ...
  files.forEach(function(file) {
    ...
    if (stats.isDirectory()) {
      Array.prototype.push.apply(dirFiles, scanFolder(dirConfig, basedir, fullFilePath));
